...
Route::prefix('admin')->middleware(['Admin_Rbac'])->group(function(){
    ...
    Route::any('index','admin\AdminController@index');
     //收货地址
     Route::any('addressed','admin\AddressController@add_do');//收货添加执行 
     Route::any('address_list','admin\AddressController@address_list');//收货展示
     Route::any('add_del/{add_id}','admin\AddressController@add_del');//收货删除
     Route::any('modify/{add_id}','admin\AddressController@modify');//收货修改
     Route::any('modify_do','admin\AddressController@modify_do');//收货修改执行  未完成
    //广告模块
