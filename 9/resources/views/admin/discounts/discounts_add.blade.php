...
@section('content')
    ...
    <div class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" name="dis_money" lay-verify="title" autocomplete="off" placeholder="请输入价格" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" name="dis_num" lay-verify="title" autocomplete="off" placeholder="请输入价格" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" name="dis_weight" lay-verify="title" autocomplete="off" placeholder="请输入权重" class="layui-input">
            </div>
        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".layui-btn").on('click',function () {
                ...
                let url="{{url('admin/discounts_do')}}";
                $.ajax({
                    data:data,
                    dataType: "json",
                    type: "post",
